            ...
            <div id="form1" >
              <div class="sixteen wide field">
                <div class="inline fields">
                  ...
                  <div class="fourteen wide field">
                    <input type="text" name="title" placeholder="Judul" value="{{$sched->title}}">
                  </div>
                </div>
              </div>
              <?php
              ...
              <div class="sixteen wide field">
                <div class="inline fields">
                  ...
                  <div class="fourteen wide field">
                    <input type="text" name="start" placeholder="Start" id="datepicker1" readonly="" value="{{$start}}">
                  </div>
                </div>
              </div>
              <div class="sixteen wide field">
                <div class="inline fields">
                  ...
                  <div class="fourteen wide field">
                    <input type="text" name="end" placeholder="End" id="datepicker2" readonly="" value="{{$end}}">
                  </div>
                </div>
              </div>
              <div class="sixteen wide field">
                <div class="inline fields">
                  ...
                  <div class="fourteen wide field">
                    <textarea name="description" placeholder="Deskripsi">{{$sched->description}}</textarea>
                  </div>
                </div>
              </div>
              {{csrf_field()}}
