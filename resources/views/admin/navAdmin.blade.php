...
<div class="ui fixed menu" style="box-shadow: 0px 3px 3px 0 rgba(187,16,21,1);">
 <div class="ui container">
    <div class="header item">
      <img class ="logo" src="{{URL::to('image/logo2.png')}}" style="50%"> <a href="{{url('/')}}"></a>
    </div>
    <a class="item" href="{{url('/')}}">Home</a>
    <a class="item" href="{{url('artikel')}}">Berita / Artikel</a>
    <a class="item" href="{{url('jadwal')}}">Jadwal Kegiatan</a>
    <a class="item" href="{{url('video')}}">Video</a>
    <!-- <a class="item" href="{{url('submissions')}}">Daftar Alumni</a> -->
